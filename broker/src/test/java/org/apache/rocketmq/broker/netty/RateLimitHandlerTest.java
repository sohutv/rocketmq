...
public class RateLimitHandlerTest {
    ...
    public static RemotingServer createRemotingServer() throws InterruptedException {
        ...
        remotingServer.registerProcessor(RequestCode.CONSUMER_SEND_MSG_BACK, new NettyRequestProcessor() {
            @Override
            public RemotingCommand processRequest(ChannelHandlerContext ctx, RemotingCommand request) {
        ...
        remotingServer.registerProcessor(RequestCode.SEND_MESSAGE, new NettyRequestProcessor() {
            @Override
            public RemotingCommand processRequest(ChannelHandlerContext ctx, RemotingCommand request) {
        ...
        remotingServer.registerProcessor(RequestCode.SEND_MESSAGE_V2, new NettyRequestProcessor() {
            @Override
            public RemotingCommand processRequest(ChannelHandlerContext ctx, RemotingCommand request) {
        ...
        remotingServer.registerProcessor(RequestCode.SEND_BATCH_MESSAGE, new NettyRequestProcessor() {
            @Override
            public RemotingCommand processRequest(ChannelHandlerContext ctx, RemotingCommand request) {
